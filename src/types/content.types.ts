...
export interface About extends BasePageConfig {
  ...
  work: {
    ...
    experiences: Array<{
      ...
      /** Technology stack used for the experience */
      stack?: Array<{
        /** Icon name from src/resources/icons.ts */
        icon: IconName;
        /** Label shown on hover / accessibility */
        label: string;
        /** Optional color to make icons vivid */
        color?: string;
      }>;
  ...
  technical: {
    ...
    skills: Array<{
      ...
      /** Technology stack with colored icons */
      stack?: Array<{
        icon: IconName;
        label: string;
        color?: string;
